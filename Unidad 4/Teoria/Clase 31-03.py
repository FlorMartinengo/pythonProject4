...
#acá hay un error, concatena los números, los concateno como un string y no como numeros. hay q convertirlo con int a numero
...
#aca esta bien la suma pq lo transformamos en numero